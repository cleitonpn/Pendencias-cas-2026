...
class SheetsService {
  ...
  static String _gvizUrl(String range) =>
      ...
      '?tqx=out:json&headers=0&sheet=projetos&range=${Uri.encodeComponent(range)}';
  ...
  static Future<List<Client>> fetchClients() async {
    ...
    for (int i = 1; i < bToIRows.length; i++) {
      ...
      // Normaliza hangar: "EXT 1" → "1", "EXT 3" → "3" etc.
      // para que externos apareçam junto com o hangar correspondente

...
class TeamLeaderClientListScreen extends StatefulWidget {
  ...
  @override
  State<TeamLeaderClientListScreen> createState() =>
      _TeamLeaderClientListScreenState();
}

class _TeamLeaderClientListScreenState
    extends State<TeamLeaderClientListScreen> {
  String _search = '';

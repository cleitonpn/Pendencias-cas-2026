...
import 'team_leader_client_list_screen.dart';
import 'team_leader_pending_list_screen.dart';

class TeamLeaderHangarListScreen extends StatefulWidget {
  final String leaderName;
  final String team;

  const TeamLeaderHangarListScreen({
    super.key,
  ...
  @override
  State<TeamLeaderHangarListScreen> createState() =>
      _TeamLeaderHangarListScreenState();
}

class _TeamLeaderHangarListScreenState
    extends State<TeamLeaderHangarListScreen> {
  ...
  Future<void> _loadCounts() async {
    ...
    final counts = await DatabaseService.getPendingCountsByTeam(
        clients.map((c) => c.rowId).toList(), widget.team);

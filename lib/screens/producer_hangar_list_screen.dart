...
class ProducerHangarListScreen extends StatefulWidget {
  ...
  const ProducerHangarListScreen({super.key, required this.producerName});

  @override
  State<ProducerHangarListScreen> createState() =>
      _ProducerHangarListScreenState();
}

class _ProducerHangarListScreenState
    extends State<ProducerHangarListScreen> {
  ...
  Future<void> _loadCounts() async {
    final clients = _producerClients;
                  ...
                  return _HangarCard(
                    ...
                    onTap: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => ProducerClientListScreen(
                            hangar: hangar,
                  ...
                  children: [
                    Text(
                        ...
                        style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold)),
                    Text('$clientCount cliente${clientCount != 1 ? "s" : ""}',
                        style: const TextStyle(
